...
/// Edits the durable host-owned settings: managed-cache quota, legacy Archive
/// compatibility, and launch-at-login (PLAT-MAC-005). Current per-account
/// Archive policy is owned by ``ContentPolicySettingsViewModel``.
///
...
public final class CompanionSettingsViewModel {
  ...
  /// Legacy compatibility value; current Archive controls do not bind here.
